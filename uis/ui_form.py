...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addLayout(self.send_to_layout, 6, 1, 1, 1)

        self.delayed_time = QDateTimeEdit(self.layoutWidget)
        self.delayed_time.setObjectName(u"delayed_time")

        self.gridLayout.addWidget(self.delayed_time, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.article_text, 1, 2, 8, 3)
        ...
        self.gridLayout.addLayout(self.gridLayout_4, 13, 1, 3, 1)
        ...
        self.gridLayout.addWidget(self.send_to_label, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.file_listWidget, 13, 2, 1, 1)
        ...
        self.file_order_up.setFont(font2)
